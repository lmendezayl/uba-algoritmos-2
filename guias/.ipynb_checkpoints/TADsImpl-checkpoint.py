...
class DiccionarioConj:
    def __init__(self) -> None:
        self.elems = set()

    def definir(self, key: object, value: object) -> None:
        for elem in self.elems:
            if elem[0] == key:
                self.elems.remove(elem)
        self.elems.add((key, value))
    
    def obtener(self, key: object) -> object:
        for elem in self.elems:
            if elem[0] == key:
                return elem[1]
            else:
    ...
    def pertenece(self, key: object) -> bool:
        for elem in self.elems:
            if elem[0] == key:
                return True
            else: 
